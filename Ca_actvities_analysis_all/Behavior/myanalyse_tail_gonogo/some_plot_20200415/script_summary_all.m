...
seg={'20200624','20200625','20200626','20200627','20200707','20200708','20200709','20200710','20200831','20200901','20200902','20200903','20200908','20200909','20200910','20200928','20200930','20201019','20201020','20201021','20201025','20201026','20201027'};
%'20200707','20200708','20200709','20200710','20200923','20200924','20200925','20201003'
n=[5,4,6,5,3,5,5,4,3,6,3,5,5,6,6,3,4,3,3,4,4,4,3];kk=1;
...
learned=[13 17 20 73 75 63 25 98 99]; %
acqlearned=[38 69 33 58];
nonlearned=[84 85 83 55 57 67 68 72 78 53 7 9 28 5 18];
all=[learned,acqlearned,nonlearned];
type=all;
%% 
ii=nonlearned;
...
%
b= V_trial_increased(:,learned);
b=V_trial_CS{3}(:,type(ind));V_trial_base{3}(:,type(ind));
...
aa=[];
for ii=1:length(a);
    if ~isempty(find(strcmp(a(ii),Name)))
    aa(ii,1)=find(strcmp(a(ii),Name));
    else
        aa(ii,1)=1;a(ii)
    end
end

b=Data.M_num_spon(1:9,aa);
bb=(b-repmat(b(1,:),9,1))./(b+repmat(b(1,:),9,1));
a1=[4,6,8,9,10,14,20,27];bb1=bb(:,a1);
a2=[1,2,3];bb2=bb(:,a2);
a3=[13,15,17,19,24,21,23,26];bb3=bb(:,a3);
a4=[5,7,12,16,22,28];bb4=bb(:,a4);
a5=[11,18,25];bb5=bb(:,a5);