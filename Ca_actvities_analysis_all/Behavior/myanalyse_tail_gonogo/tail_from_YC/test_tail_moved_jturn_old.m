...
savepath = checkpath('Z:/data/20151110/');
% movind = 1:nframes;
...
params.prolong_factor = 2;
params.turn_scope = 30;
params.turn_step = 2;
params.max_width = 17;
params.min_width = 5;
...
frame1 = imread(fpaths{movind(1)});  % generate by movement_detection
...
for ii = 1:length(tind)  %53101:53520 %movind(2000:end)'
    ...
    engim = normim(engim, [1/1000, 1/1000]);  % caution: inline params
