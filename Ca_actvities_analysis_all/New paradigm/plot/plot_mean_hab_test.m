function [rawacti, area] = plot_mean_hab_test(acti,fs,trial,frame,frameb,startpoint,cut_move,ind_cut_trial)
...
subplot(2,4,8)
[~,area]=calculate_integtate_dfdf_main(acti,cut_move,trial,frame,fs,ind_cut_trial);
