function [area] = plot_meantrace_acq_control(acti,fs,trial,frame,cut_move,ind_cut_trial)
...
[rawacti,area]=calculate_integtate_dfdf_main_control(acti,cut_move,trial,frame,fs,ind_cut_trial);
