function [loc_in_region_in_clust_r,index_in_region_in_clust_r,fraction_in_region_in_clust_r,loc_in_region_cell,id_in_region_cell,num_in_region_in_clust_r,Lable]=get_region_fraction_temp(region_mask,reg_name,reg_loc,gIX,surpervolxel,loc_temp,cmap,isplot,nn)
...
loc_in_region_in_clust={};loc_in_region_cell={};fraction_in_region_in_clust=nan(size(reg_name,2),max(unique(gIX)));id_in_region_cell={};
